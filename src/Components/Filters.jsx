...
import { FaBurger, FaPizzaSlice, FaBowlFood } from "react-icons/fa6";
        ...
        <>
            <div className='bg-white lg:flex justify-between h-[100px] lg:h-[50px] lg:sticky top=[100px] lg:top-[88px] z-50 bg-opacity-70 items-center' >
                <div className='w-4/5 flex gap-4 justify-betweet items-center px-8 h-[50px] lg:h-[100px]'>
                    <div className='flex gap-2 items-center cursor-pointer' onClick={() => setQuery('burger')}>
                        <FaBurger color={'#8D3838'} />
                        <p>Burgers</p>
                    </div>
                    ...
                    <div className='flex gap-2 items-center cursor-pointer' onClick={() => setQuery('pizza')}>
                        <FaPizzaSlice color={'#8D3838'} />
                        <p>Pizza</p>
                    </div>
